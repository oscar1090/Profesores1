<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="prod-aca_libros1.aspx.cs" Inherits="CtrlProfesores.Vistas.prod_aca_libros1" %>
	...
	<div class="encavezado" >
        ...
        <p>
            <table style="width:100%;">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label26" runat="server" Text="Tipo de participación*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label28" runat="server" Text="Páginas*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label8" runat="server" Text="Tiraje*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style3">
                        <asp:Label ID="Label27" runat="server" Text="Fecha de publicación*"></asp:Label>
                    </td>
                    <td class="style1">
