<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="prod-aca_prod-art1.aspx.cs" Inherits="CtrlProfesores.Vistas.prod_aca_prod_art1" %>
...
<div data-role="page" class="type-interior">
	...
	<div class="encavezado" >
        ...
        <p>Si selecciona como Tipo de Producción la opción &quot;Composición Musical&quot; deberá 
            indicar si usted es Intérprete o Ejecutante en el campo &quot;Descripción&quot;.</p>
        <p>
            <table style="width:100%;">
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label1" runat="server" Text="Tipo de producción*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label26" runat="server" 
                            Text="Nombre de la obra*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label20" runat="server" 
                            ...
                            Text="Describa el impacto de la producción artística para la investigación*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label17" runat="server" 
                            Text="Describa el impacto en metodología*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label31" runat="server" 
                            Text="Describa el impacto en innovación*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label33" runat="server" Text="Fecha de publicación*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label34" runat="server" Text="Lugares donde se presentó*"></asp:Label>
                    </td>
                    <td class="style4">
...
&nbsp;</td>
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label35" runat="server" Text="Propósito*"></asp:Label>
                    </td>
                    <td class="style4">
