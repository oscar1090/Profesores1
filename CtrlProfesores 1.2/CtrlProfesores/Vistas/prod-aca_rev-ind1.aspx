<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="prod-aca_rev-ind1.aspx.cs" Inherits="CtrlProfesores.Vistas.prod_aca_rev_ind1" %>
	...
	<div class="encavezado" >
        ...
        <p>
            <table style="width:100%;">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label4" runat="server" Text="Nombre de la revista*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label18" runat="server" Text="Volumen*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label8" runat="server" Text="Índice de registro de la revista*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label19" runat="server" 
                            Text="Estado actual*"></asp:Label>
                    </td>
                    <td class="style4">
                        <asp:DropDownList ID="DropDownList3" runat="server" Height="16px" Width="123px">
                            <asp:ListItem>Seleccione</asp:ListItem>
                            <asp:ListItem> </asp:ListItem>
                            <asp:ListItem>AceptadoPublicado</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
            </table>
