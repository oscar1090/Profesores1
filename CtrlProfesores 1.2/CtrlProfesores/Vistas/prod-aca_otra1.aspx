<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="prod-aca_otra1.aspx.cs" Inherits="CtrlProfesores.Vistas.prod_aca_otra1" %>
	...
	<div class="encavezado" >
        ...
        <p>
            <table style="width:100%;">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label40" runat="server" Text="Propósito*"></asp:Label>
                    </td>
                    <td class="style4">
                        <asp:DropDownList ID="DropDownList18" runat="server" Height="16px" 
                            Width="123px">
