<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="prod-aca_inf-tec1.aspx.cs" Inherits="CtrlProfesores.Vistas.prod_aca_inf_tec1" %>
	...
	<div class="encavezado" >
        ...
        <p>
            <table style="width:100%;">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label2" runat="server" 
                            Text="Nombre del estudio o proyecto realizado*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label16" runat="server" Text="Alcance*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label4" runat="server" Text="Institución beneficiaria"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label17" runat="server" Text="Fecha de inicio de proyecto*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label18" runat="server" Text="Estado actual del proyecto*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label8" runat="server" Text="Fecha de elaboración del informe*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style3">
                        <asp:Label ID="Label9" runat="server" Text="Número de páginas*"></asp:Label>
                    </td>
                    <td class="style1">
