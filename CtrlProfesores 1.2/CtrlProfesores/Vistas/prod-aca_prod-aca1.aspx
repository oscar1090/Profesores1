<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="prod-aca_prod-aca1.aspx.cs" Inherits="CtrlProfesores.Vistas.prod_aca_prod_aca1" %>
...
<div data-role="page" class="type-interior">
	...
	<div class="encavezado" >
        ...
        <p>Articulo de Difusión y Divulgación</p>
        ...
        <p>
            <table style="width:100%;">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label6" runat="server" Text="De la página*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label8" runat="server" Text="A la página*"></asp:Label>
                    </td>
                    <td class="style4">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label12" runat="server" 
                            Text="¿Conciderar para el curriculum de cuarpo academico?*"></asp:Label>
                    </td>
                    <td class="style4">
